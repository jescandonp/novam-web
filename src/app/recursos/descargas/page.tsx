...
const PUBLIC_DOCS = [
  {
    brand: "Flexim",
    title: "Catálogo General Flexim",
    description: "Línea completa de caudalímetros ultrasónicos clamp-on para líquidos, gases y energía térmica.",
    pages: "48 páginas",
    variant: "brand" as const,
    href: "/brochures/flexim-general.pdf",
    badge: "Distribuidor Autorizado",
  },
  {
    brand: "Flexim",
    title: "PIOX R — Refractometría en línea",
    description: "Medición de concentración no invasiva: grados Brix, densidad relativa y composición de mezclas.",
    pages: "12 páginas",
    variant: "brand" as const,
    href: "/brochures/flexim-piox-r.pdf",
    badge: "Alimentos & Bebidas",
  },
  {
    brand: "Smar",
    title: "Catálogo LD300 — Transmisores de Presión",
    description: "Transmisores de presión diferencial, manométrica y absoluta con protocolo HART y Fieldbus.",
    pages: "24 páginas",
    variant: "tech" as const,
    href: "/brochures/smar-ld300.pdf",
    badge: "Partner Exclusivo Colombia",
  },
  {
    brand: "Smar",
    title: "Sistema DFI302 — Foundation Fieldbus",
    description: "Integración total de instrumentación digital en red Fieldbus. Hasta 70% menos cableado.",
    pages: "16 páginas",
    variant: "tech" as const,
    href: "/brochures/smar-dfi302.pdf",
    badge: "Automatización",
  },
  {
    brand: "UWT",
    title: "Catálogo Rotonivo & NivoRadar",
    description: "Detección y medición de nivel en sólidos a granel, polvos y granulados. Garantía 6 años.",
    pages: "20 páginas",
    variant: "sector" as const,
    href: "/brochures/uwt-nivel.pdf",
